...
<html>
	...
	<body>
		...
		<div id="div-nosesion" style="display: none">
			<!--Div for show the error screen due to not connection to facebook app handle with JQuery -->
			<!--<script>
				/*$(document).ready(function(){
			    $("a").hover(function(){
			...
			<br>
			<p align="center">
				Este proyecto necesita una conexion a facebook<br> Por favor inicia
				sesion para continuar
			<br><br><br> 
			<a href="javascript:void(0)" onclick="fblogin()"><img title="Inicia sesi�n en Facebook para continuar" src="../css/images/facebook_login.png"></a>
			</p>
		</div>
			...
			window.fbAsyncInit = function() {
				...
				FB.getLoginStatus(function(response) { //Get the login access, if not found one, alert you and open a frame with the login form
					if (response.status === 'connected') {
						...
						console.log('No hay ninguna sesion iniciada');
		...
		<div id="contenedor">
			...
			<p>Aqu&iacute; se hospedaran los comentarios que usaremos para
				guardarlos en una base de datos para su posterior analisis por medio
			de una red neuronal para determinar el grado de violencia</p>
			
			<!-- SECCION INFORMACION EMPIEZA-->
			<!--<div id="ContenedorDivsInformativos">
				<p>
					<a class="A" href="#" id="DataUsage">Que datos recopilamos</a>
				</p>
				<div id="DataUsageDiv" style="display: none; text-align: left">
					<p>
						<br> <b>ID de usuario</b>: Requerido para un ordenamiento de datos por caracteres numericos<br>
		...
		<div id="footer">
			<div style="text-align: center">
				<p>Sistemas Inteligentes - Aula 4206 - Semestre Enero - Junio 2015  FIME-UANL</p>
			</div>
		</div>
